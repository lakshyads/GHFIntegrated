...
public class SomeData {
    ...
    public SomeData() {
        ...
        Bedproducts.put("Columba King Bed@899@plane_bed@plane_bed.sfb", R.drawable.queen_size_bed);
        ...
        Othproducts.put("Premium Table Lamp@65@table_lamp@table_lamp.sfb", R.drawable.tablelamp);
        Othproducts.put("Vintage Wooden Table@80@vintage_wooden_table@vintage_wooden_table.sfb", R.drawable.vintagewoodtable);
